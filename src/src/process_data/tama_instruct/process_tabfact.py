...
root_dir = "../datasets/tama_instruct/tabfact"


def process(name: str = "tabfact", outfilename: str = "tabfact_test", infilename: str = "tabfact_test") -> None:
...
if __name__ == "__main__":
    process()
    process(outfilename="train", infilename="tabfact_train_92283")