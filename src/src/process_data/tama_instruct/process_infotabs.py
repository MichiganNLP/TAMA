...
def process(split: str) -> None:
    ...
    if split == "test":
        data = read_tsv_as_dict_list(f"{root_dir}/raw/infotabs/data/maindata/infotabs_test_alpha1.tsv")
        data += read_tsv_as_dict_list(f"{root_dir}/raw/infotabs/data/maindata/infotabs_test_alpha2.tsv")
        data += read_tsv_as_dict_list(f"{root_dir}/raw/infotabs/data/maindata/infotabs_test_alpha3.tsv")
    elif split == "train":
        data = read_tsv_as_dict_list(f"{root_dir}/raw/infotabs/data/maindata/infotabs_train.tsv")
    else:
