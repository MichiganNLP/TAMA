...
root_dir = "../datasets/tama_instruct/fetaqa"


def process(name: str = "fetaqa", outfilename: str = "fetaqa_test", infilename: str = "fetaqa_test") -> None:
...
if __name__ == "__main__":
    process()
    process(outfilename="train", infilename="fetaqa_train_7325")