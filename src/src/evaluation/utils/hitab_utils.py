""" 
Copied from https://github.com/OSU-NLP-Group/TableLlama/blob/main/eval_scripts/table_utils.py
"""
import re
import math
import numpy as np

from src.evaluation.utils.qa_datadump_utils import naive_str_to_float
