""" 
From https://github.com/xlang-ai/UnifiedSKG/tree/main/metrics/kvret
"""
# encoding=utf8
...
class EvaluateTool(object):
    ...
    def evaluate(self, preds, golds, section):
        ...
        global_entities = load_entities(
            "/code/tablellm/datasets/kvret/raw/kvret_entities.json"
        )
        ...
        if section in ["train", "dev"]:
            ...
            metric_list = [
                # "bleu",
                "/code/tablellm//src/src/evaluation/utils/kvret_utils.py"
            ]

        for metric_name in metric_list:
            metric = load_metric(metric_name)

            if metric_name == "/code/tablellm//src/src/evaluation/utils/kvret_utils.py":
                gold_responses = [
                    {"response": item["seq_out"], "intents": [item["intent"]],}
                    for item in golds
                ]
                res = metric.compute(
                    **{
