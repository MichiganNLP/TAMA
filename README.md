...
## 🔥 News
 - 2025.7 We release the model [checkpoints](https://huggingface.co/collections/MichiganNLP/tama-models-684eeb3e7f262362856eccd1) based on QWen2.5 and QWen3, with [TAMA-QWen3](https://huggingface.co/MichiganNLP/TAMA-QWen3) yielding 33.9 (SOTA among 7B/8B Table LLMs) on MMTU 🤗.
